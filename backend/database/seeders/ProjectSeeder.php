...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('projects')->insert([
            ...
            [
                'id' => 5,
                'team_name' => 'アナログゲーム同好会',
                'project_name' => 'Cafe the Board',
                'project_description' => 'これは企画を説明する文章です。',
                'project_space' => 'T4',
                'vote' => 0,
            ],
            ...
            [
                'id' => 17,
                'team_name' => 'クトゥルフ研究愛好会',
                'project_name' => 'ベビーカステラ',
                'project_description' => 'これは企画を説明する文章です。',
                'project_space' => 'T4',
                'vote' => 0,
            ],
            ...
            [
                'id' => 31,
                'team_name' => '戦術研究同好会',
                'project_name' => 'Vasa:Shooting range',
                'project_description' => 'これは企画を説明する文章です。',
                'project_space' => 'T4',
                'vote' => 0,
            ],
            ...
            [
                'id' => 40,
                'team_name' => '音楽部',
                'project_name' => 'north five jazz orchestra',
                'project_description' => 'これは企画を説明する文章です。',
                'project_space' => 'T4',
                'vote' => 0,
            ],
            ...
            [
                'id' => 56,
                'team_name' => '航空技術者育成プログラム',
                'project_name' => '飛行機に触れてみましょう！',
                'project_description' => 'これは企画を説明する文章です。',
                'project_space' => 'T4',
                'vote' => 0,
            ]
